...
<HiSearch size={40} className='absolute top-2 end-0 text-purple-900 font-black cursor-pointer hidden md:flex'/>
<HiSearch size={30} className='absolute top-2 end-0 text-purple-900 font-black cursor-pointer flex md:hidden'/>
