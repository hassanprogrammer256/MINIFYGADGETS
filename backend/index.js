...
// General function to handle database connections and operations
async function main() {
    try {
...
app.post('/manyproducts', async (req, res) => {
  const newProducts = req.body; // Expecting an array of products
...
app.post('/search', async (req, res) => {
  ...
  try {
      ...
      res.status(500).json({ error: 'Internal server error' });
        ...
        // Additional code for confirming OTP and other routes can remain as is...
